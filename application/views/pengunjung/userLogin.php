                ...
                <?php foreach ($tempatWisata as $tw) : ?>
                    <div class="col-xl-4 col-lg-4 col-md-6">
                        <div class="single-place mb-30">
                            <div class="place-img">
                                <img src="<?php echo base_url('assets/img/' . $tw['foto']) ?>" />
                            </div>
                            <div class="place-cap">
                                ...
                                <div class="place-cap-bottom">
                                    <ul>
                                        ...
                                        <li><i class="fas fa-map-marker-alt"></i><?= $tw['lokasi']; ?></li>
                                    </ul>
                                    <br>
                ...
                <div class="col-xl-6 col-lg-6">
                    <div class="right-caption">
                        ...
                        <div class="support-caption">
                            ...
                            <a href="<?= base_url('aboutUs/userLoginAbout') ?>" class="btn border-btn">About us</a>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-xl-6 col-lg-6 col-md-6">
                    <div class="home-blog-single mb-30">
                        <div class="blog-img-cap">
                            <div class="blog-img">
                                <img src="<?= base_url('vendor/'); ?>assets/img/blog/home-blog1.jpg" alt="">
                            </div>
                            <div class="blog-cap">
                                <p> | Traveling</p>
                ...
                <div class="col-xl-6 col-lg-6 col-md-6">
                    <div class="home-blog-single mb-30">
                        <div class="blog-img-cap">
                            <div class="blog-img">
                                <img src="<?= base_url('vendor/'); ?>assets/img/blog/home-blog2.jpg" alt="">
                            </div>
                            <div class="blog-cap">
                                <p> | Traveling</p>
                                <h3><a href="single-blog.html">Tips For Taking A Long-Term Trip With Kids.</a></h3>
